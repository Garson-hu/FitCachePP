#!/bin/bash
#SBATCH -J dinov2_FitCachePP
#SBATCH -t 00:30:00
#SBATCH -N 1
#SBATCH -C nvme
#SBATCH -p batch
#SBATCH --account=gen008
#SBATCH -o /lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/dinov2_compare/20260517_231535_dinov2_compare/FitCachePP/dinov2_FitCachePP-%j.out
...
RESULTS_DIR="/lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/dinov2_compare/20260517_231535_dinov2_compare/FitCachePP"
cd "$RESULTS_DIR"
