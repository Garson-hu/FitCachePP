#!/bin/bash
#SBATCH -J dinov2_Pure_CF
#SBATCH -t 00:30:00
#SBATCH -N 1
#SBATCH -C nvme
#SBATCH -p batch
#SBATCH --account=gen008
#SBATCH -o /lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/dinov2_compare/20260515_011400_dinov2_compare/Pure_CF/dinov2_Pure_CF-%j.out
...
RESULTS_DIR="/lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/dinov2_compare/20260515_011400_dinov2_compare/Pure_CF"
cd "$RESULTS_DIR"
