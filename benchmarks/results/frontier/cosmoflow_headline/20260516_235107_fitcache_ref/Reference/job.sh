...
#SBATCH -q hackathon
#SBATCH -o /lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/cosmoflow_headline/20260516_235107_fitcache_ref/Reference/cosmoflow_RefFitCache-%j.out
...
RESULTS_DIR="/lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/cosmoflow_headline/20260516_235107_fitcache_ref/Reference"
cd "$RESULTS_DIR"
...
echo "[Reference] nodes=$SLURM_NNODES total_servers=$HVAC_SERVER_COUNT gpus_per_node=8"
...
# Spawn servers
echo "[Reference] launching 2 servers via srun"
srun -N 1 -n 2 --ntasks-per-node=2 \
     --cpus-per-task=1 --cpu-bind=cores \
     "/lustre/orion/gen008/proj-shared/ghu4/FitCache_Frontier/build_v2/src/hvac_server" 2 \
...
echo "[Reference] launching training: $((N_NODES * 8)) GPUs total"
START=$SECONDS
