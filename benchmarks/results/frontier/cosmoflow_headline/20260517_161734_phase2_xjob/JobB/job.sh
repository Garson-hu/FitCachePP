...
#SBATCH -q hackathon
#SBATCH -o /lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/cosmoflow_headline/20260517_161734_phase2_xjob/JobB/cosmoflow_JobB-%j.out
...
RESULTS_DIR="/lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/cosmoflow_headline/20260517_161734_phase2_xjob/JobB"
mkdir -p "$RESULTS_DIR"
cd "$RESULTS_DIR"
...
export FitCache_CLUSTER_REGISTRY_DIR=/lustre/orion/gen008/proj-shared/ghu4/fitcachepp_registry/phase2_xjob/20260517_161734_phase2_xjob
...
echo "[JobB] launching training: $((N_NODES * 8)) GPUs"
START=$SECONDS
