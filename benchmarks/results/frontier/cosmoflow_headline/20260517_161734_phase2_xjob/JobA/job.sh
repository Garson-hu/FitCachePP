...
#SBATCH -q hackathon
#SBATCH -o /lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/cosmoflow_headline/20260517_161734_phase2_xjob/JobA/cosmoflow_JobA-%j.out
...
RESULTS_DIR="/lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/cosmoflow_headline/20260517_161734_phase2_xjob/JobA"
mkdir -p "$RESULTS_DIR"
cd "$RESULTS_DIR"
...
echo "[JobA] launching training: $((N_NODES * 8)) GPUs"
START=$SECONDS
