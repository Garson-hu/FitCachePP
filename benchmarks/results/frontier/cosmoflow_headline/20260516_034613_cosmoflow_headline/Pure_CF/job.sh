...
#SBATCH -q debug
#SBATCH -o /lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/cosmoflow_headline/20260516_034613_cosmoflow_headline/Pure_CF/cosmoflow_Pure_CF-%j.out
...
RESULTS_DIR="/lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/cosmoflow_headline/20260516_034613_cosmoflow_headline/Pure_CF"
mkdir -p "$RESULTS_DIR"
cd "$RESULTS_DIR"
...
export FitCache_DRAM_PATH=/tmp/fitcachepp_Pure_CF_20260516_034613_cosmoflow_headline_dram
export FitCache_NVME_PATH=/tmp/fitcachepp_Pure_CF_20260516_034613_cosmoflow_headline_nvme
