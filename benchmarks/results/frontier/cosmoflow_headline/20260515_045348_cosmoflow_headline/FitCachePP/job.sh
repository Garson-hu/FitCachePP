...
#SBATCH -o /lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/cosmoflow_headline/20260515_045348_cosmoflow_headline/FitCachePP/cosmoflow_FitCachePP-%j.out
...
RESULTS_DIR="/lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/cosmoflow_headline/20260515_045348_cosmoflow_headline/FitCachePP"
mkdir -p "$RESULTS_DIR"
cd "$RESULTS_DIR"
...
export FitCache_DRAM_PATH=/tmp/fitcachepp_FitCachePP_20260515_045348_cosmoflow_headline_dram
export FitCache_NVME_PATH=/tmp/fitcachepp_FitCachePP_20260515_045348_cosmoflow_headline_nvme
...
echo "[$SIDE] nodes=$SLURM_NNODES  total_servers=$FitCache_SERVER_COUNT  gpus_per_node=8"
echo "[$SIDE] data=$FitCache_DATA_DIR"

# ---- spawn FitCachePP servers (always, even on Pure_CF; Pure_CF just doesn't LD_PRELOAD)
echo "[$SIDE] launching 2 servers via srun"
...
echo "[$SIDE] launching training: $((N_NODES * 8)) GPUs total"
START=$SECONDS
