...
#SBATCH -q hackathon
#SBATCH -o /lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/cosmoflow_headline/20260517_151302_phase2_xjob/JobA/cosmoflow_JobA-%j.out
...
RESULTS_DIR="/lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/cosmoflow_headline/20260517_151302_phase2_xjob/JobA"
mkdir -p "$RESULTS_DIR"
cd "$RESULTS_DIR"
...
if [ "JobA" = "JobB" ] && [ "0" -gt 0 ]; then
    echo "[$SIDE] sleeping 0s so JobA has cache warmed before JobB starts"
    sleep 0
fi
