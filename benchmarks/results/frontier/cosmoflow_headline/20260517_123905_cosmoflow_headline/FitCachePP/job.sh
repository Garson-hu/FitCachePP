...
#SBATCH -q hackathon
#SBATCH -o /lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/cosmoflow_headline/20260517_123905_cosmoflow_headline/FitCachePP/cosmoflow_FitCachePP-%j.out
...
RESULTS_DIR="/lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/cosmoflow_headline/20260517_123905_cosmoflow_headline/FitCachePP"
mkdir -p "$RESULTS_DIR"
cd "$RESULTS_DIR"
...
export FitCache_DRAM_PATH=/tmp/fitcachepp_FitCachePP_20260517_123905_cosmoflow_headline_dram
export FitCache_NVME_PATH=/tmp/fitcachepp_FitCachePP_20260517_123905_cosmoflow_headline_nvme
