...
#SBATCH -q hackathon
#SBATCH -o /lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/crossjob_sharing/20260517_215705_xjob_sharing/JobB/JobB-%j.out
...
RESULTS_DIR="/lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/crossjob_sharing/20260517_215705_xjob_sharing/JobB"
mkdir -p "$RESULTS_DIR"
cd "$RESULTS_DIR"
...
export FitCache_DRAM_PATH=/tmp/xjob_JobB_20260517_215705_xjob_sharing_dram
export FitCache_NVME_PATH=/tmp/xjob_JobB_20260517_215705_xjob_sharing_nvme
...
echo "[JobB] nodes=1  total_servers=$FitCache_SERVER_COUNT  cross_job=1  registry=/lustre/orion/gen008/proj-shared/ghu4/fitcachepp_registry/crossjob_sharing/20260517_215705_xjob_sharing"
...
echo "[JobB] launching 4 servers via srun"
