...
#SBATCH -q hackathon
#SBATCH -o /lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/crossjob_sharing/20260517_215705_xjob_sharing/JobA/JobA-%j.out
...
if [ "0" -gt 0 ]; then
    echo "[JobA] sleeping 0s to let the other job warm its cache"
    sleep 0
fi

RESULTS_DIR="/lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/crossjob_sharing/20260517_215705_xjob_sharing/JobA"
mkdir -p "$RESULTS_DIR"
cd "$RESULTS_DIR"
...
export FitCache_DRAM_PATH=/tmp/xjob_JobA_20260517_215705_xjob_sharing_dram
export FitCache_NVME_PATH=/tmp/xjob_JobA_20260517_215705_xjob_sharing_nvme
...
export FitCache_CLUSTER_REGISTRY_DIR="/lustre/orion/gen008/proj-shared/ghu4/fitcachepp_registry/crossjob_sharing/20260517_215705_xjob_sharing"
...
export MIOPEN_USER_DB_PATH=/tmp/miopen_cache_JobA_$SLURM_PROCID
...
echo "[JobA] nodes=1  total_servers=$FitCache_SERVER_COUNT  cross_job=1  registry=/lustre/orion/gen008/proj-shared/ghu4/fitcachepp_registry/crossjob_sharing/20260517_215705_xjob_sharing"
echo "[JobA] DRAM=$FitCache_DRAM_PATH (local — starts empty by design)"

# Spawn FitCache servers (N/node; default 4 — see SERVERS_PER_NODE above).
echo "[JobA] launching 4 servers via srun"
