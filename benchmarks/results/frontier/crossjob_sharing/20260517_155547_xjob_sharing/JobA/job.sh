...
#SBATCH -q hackathon
#SBATCH -o /lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/crossjob_sharing/20260517_155547_xjob_sharing/JobA/JobA-%j.out
...
RESULTS_DIR="/lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/crossjob_sharing/20260517_155547_xjob_sharing/JobA"
mkdir -p "$RESULTS_DIR"
cd "$RESULTS_DIR"
...
export FitCache_DRAM_PATH=/tmp/xjob_JobA_20260517_155547_xjob_sharing_dram
export FitCache_NVME_PATH=/tmp/xjob_JobA_20260517_155547_xjob_sharing_nvme
...
export FitCache_CLUSTER_REGISTRY_DIR="/lustre/orion/gen008/proj-shared/ghu4/fitcachepp_registry/crossjob_sharing/20260517_155547_xjob_sharing"
...
echo "[JobA] nodes=1  total_servers=$FitCache_SERVER_COUNT  cross_job=1  registry=/lustre/orion/gen008/proj-shared/ghu4/fitcachepp_registry/crossjob_sharing/20260517_155547_xjob_sharing"
