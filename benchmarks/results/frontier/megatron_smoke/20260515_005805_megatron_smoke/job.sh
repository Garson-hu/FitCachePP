...
#SBATCH -o /lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/megatron_smoke/20260515_005805_megatron_smoke/megatron_smoke-%j.out
...
NODE=$(hostname -s)
RESULTS_DIR="/lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/megatron_smoke/20260515_005805_megatron_smoke"
cd "$RESULTS_DIR"
