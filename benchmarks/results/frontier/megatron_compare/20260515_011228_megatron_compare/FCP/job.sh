#!/bin/bash
#SBATCH -J megatron_FCP
#SBATCH -t 01:00:00
#SBATCH -N 1
#SBATCH -C nvme
#SBATCH -p batch
#SBATCH --account=gen008
#SBATCH -o /lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/megatron_compare/20260515_011228_megatron_compare/FCP/megatron_FCP-%j.out
...
RESULTS_DIR="/lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/megatron_compare/20260515_011228_megatron_compare/FCP"
cd "$RESULTS_DIR"
