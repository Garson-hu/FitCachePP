#!/bin/bash
#SBATCH -J megatron_Pure_CF
#SBATCH -t 01:00:00
#SBATCH -N 1
#SBATCH -C nvme
#SBATCH -p batch
#SBATCH --account=gen008
#SBATCH -o /lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/megatron_compare/20260515_024201_megatron_compare/Pure_CF/megatron_Pure_CF-%j.out
...
RESULTS_DIR="/lustre/orion/gen008/proj-shared/ghu4/FitCachePP/benchmarks/results/frontier/megatron_compare/20260515_024201_megatron_compare/Pure_CF"
cd "$RESULTS_DIR"
...
END=$SECONDS
ELAPSED=$((END - START))
echo "=== side=Pure_CF done $(date) wall=${ELAPSED}s ==="
