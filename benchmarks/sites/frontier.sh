...
# Generated by scripts/env/stage_megatron_dinov2_data.sh.
export FITPP_MEGATRON_TOKENIZER_DIR="${FITPP_PFS_DATA_ROOT}/megatron/tokenizer"
export FITPP_MEGATRON_CORPUS_PREFIX="${FITPP_PFS_DATA_ROOT}/megatron/enwik8/enwik8_text_document"
