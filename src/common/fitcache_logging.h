 ...
 *
 * Updated:    11/16/20 - Purpose moved to FitCache modified to build without 
 *             warning under C++
 * 
...
#ifndef _FitCache_LOGGING_H_
#define _FitCache_LOGGING_H_
...
#include "log4c.h"
...
#ifdef __cplusplus
    extern "C" void fitcache_init_logging();
    ...
    void fitcache_finalize_logging();
...
#ifdef FitCache_CLIENT
#define L4C_CAT_NAME "FitCache_CLIENT"
...
#define L4C_LOG_NAME_PREFIX (char *)"fitcache_intercept_log"
#elif defined FitCache_SERVER
#define L4C_CAT_NAME "fitcache_server"

// /tmp is a lousy location for these log files and probably only useful
// for the fitcache developers.  That said, it's the best I can think of
// right now.  It's going to be imperative that users set an environment
// variable for the log file location.
#define L4C_LOG_DIR "."
#define L4C_LOG_NAME_PREFIX "fitcache_server_log"
#else
// In case we somehow forgot to define the correct macro
#error Neither FitCache_CLIENT nor FitCache_SERVER was defined! Check your build scripts!
#define L4C_CAT_NAME "fitcache_UNKNOWN"
...
#define FitCache_LOG_LEVEL "FitCache_LOG_LEVEL"

// Name of an environment variable the user can define to set the location
// of the log files.
#define FitCache_LOG_DIR "FitCache_LOG_DIR"
...
#define FitCache_LOG_PREFIX "FitCache_LOG_PREFIX"
